...
class Department(models.Model):
    ...
    department_head = models.IntegerField(null=True, blank=True)
...
class Designation(models.Model):
    ...
    department_id = models.ForeignKey(
        Department, 
        on_delete=models.CASCADE,  # Handle deletion behavior
        # related_name='department',  # Optional: reverse lookup name
    )
    company_id = models.IntegerField()
...
class NewTableLeave(models.Model):
    leave_id = models.AutoField(primary_key=True)  # Integer field for leave_id
    leave_type = models.CharField(max_length=45)  # Char field for leave_type with a max length of 45

    class Meta:
        db_table = 'newtable_leave'  # Explicitly set the database table name
        verbose_name = 'Leave'
        verbose_name_plural = 'Leaves'
        managed = False

    def __str__(self):
        return f"Leave ID: {self.leave_id}, Type: {self.leave_type}"
...
class LeaveApplication(models.Model):
    ...
    from_date = models.DateField()  # Changed to DateField
    to_date = models.DateField()    # Changed to DateField
    reason = models.TextField()
    remarks = models.TextField()
    status = models.BooleanField()
    is_half_day = models.BooleanField()
    leave_attachment = models.CharField(max_length=255, null=True, blank=True)
    created_at = models.DateTimeField(default=timezone.now)  # Changed to DateTimeField
    ...
    def __str__(self):
        return f"Leave Application {self.leave_id} for Employee {self.employee_id}"
    
class BiomatricDataTemp(models.Model):
    biomatric_id = models.AutoField(primary_key=True)  # Auto-incrementing primary key (INT)
    ...
    attendance_date = models.CharField(max_length=100,default=timezone.now().today,
                                     db_column='attendance_date',  )  # VARCHAR(100)
...
class CIProjectFile(models.Model):
    ...
    attachment_file = models.TextField()  # Use FileField if handling file uploads
...
class ci_employee_exit(models.Model):
    exit_id = models.AutoField
    company_id = models.IntegerField()
    employee_id = models.IntegerField()
    exit_date = models.CharField(max_length=255)
    exit_type_id = models.IntegerField()
    sub_exit_type_id = models.CharField(max_length=120, blank=True, null=True)
    exit_interview = models.IntegerField()
    is_inactivate_account = models.IntegerField()
    reason = models.TextField()
    accountability_to = models.CharField(max_length=200)
    added_by = models.IntegerField()
    created_at = models.CharField(max_length=255)

    def __str__(self):
        return f"Exit {self.exit_id} - Employee {self.employee_id}"

    class Meta:
        db_table = "ci_employee_exit"

# Priti DEsignation 

from django.db import models

class CiDesignation(models.Model):
    designation_id = models.AutoField(primary_key=True)
    department_id = models.IntegerField()
    company_id = models.IntegerField()
    designation_name = models.CharField(max_length=200)
    designation_code = models.CharField(max_length=100)
    line_manager_id = models.IntegerField()
    description = models.TextField()
    created_at = models.CharField(max_length=200)
...
class Announcement(models.Model):
    ...
    start_date = models.DateField()
    end_date = models.DateField()
    published_by = models.IntegerField()  # Assuming it's an ID of the user
    summary = models.TextField()
    description = models.TextField()
    is_active = models.BooleanField(default=True)
    created_at = models.CharField(max_length=255, null=False,default=timezone.now())  
...
class Event(models.Model):
    ...
    company_id = models.IntegerField(max_length=255 , blank=True, null=True)
    employee_id = models.CharField(max_length=255, blank=True, null=True)
    event_title = models.CharField(max_length=255)
    event_date = models.DateField()
    event_time = models.TimeField()
    event_color = models.CharField(max_length=50, default="#7267EF")
...
class Holiday(models.Model):
    ...
    employee_hub = models.CharField(blank=True, null=True)
...
class CITravel(models.Model):
    ...
    visit_place = models.CharField(max_length=255)
    travel_mode = models.IntegerField()
    arrangement_type = models.IntegerField()
    expected_budget = models.DecimalField(max_digits=65, decimal_places=2)
    actual_budget = models.DecimalField(max_digits=65, decimal_places=2)
    description = models.TextField()
    ...
    def __str__(self):
        return f"Travel ID: {self.travel_id}"
    class Meta:
        db_table='ci_travels'